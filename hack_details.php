...
<body>
	<table class="messagestyle" align="center" style="background-image:url(<?php echo(SettingsMod::STATIC_IMAGES)?>/bg.gif)">
	<tbody>
	<tr>
		<th colspan="3">
			<script type="text/javascript">document.write(formatDate(<?php echo(strtotime($hack["date"]) * 1000)?>))</script><br>
	...
	<tr>
		...
		<td>
			<table width="<?php echo($status["amount"])?>" cellspacing="0" cellpadding="0" border="0" style="background-color:<?php echo($status["color"])?>;height:1px;">
	...
	<br>
	<table class="messagestyle" align="center" style="background-image:url(<?php echo(SettingsMod::STATIC_IMAGES)?>/bgdark.gif)">
	<tr>
	...
	<tr>
		<td align="center">
			...
			<br>
			<?php endif;?>
			<table class="messagestyle" style="background-image:url(<?php echo(SettingsMod::STATIC_IMAGES)?>/bg.gif)">
			<tr>
				<th colspan="2">
			...
			<tr>
				...
				<?php if ($building["commodities"]):?>
					<?php for ($j = 0; $j < count($building["commodities"]); $j++):?>
						...
						<img src="<?php printf("%s/res/%s", SettingsMod::STATIC_IMAGES, $building["commodities"][$j]["img"])?>" alt="">:&nbsp;<?php echo($building["commodities"][$j]["amount"])?>&nbsp;
					<?php endfor;?>
				<?php endif;?>
				</td>
				<td align="center" nowrap>
				<?php if ($building["stock"]):?>
					<?php for ($j = 0; $j < count($building["stock"]); $j++):?>
						<?php if (($j % $resPerRow == 0) && ($j != 0)) echo("<br>")?>
						<img src="<?php printf("%s/res/%s", SettingsMod::STATIC_IMAGES, $building["stock"][$j]["img"])?>" alt="">:&nbsp;<?php echo($building["stock"][$j]["amount"])?>&nbsp;
					<?php endfor;?>
				<?php endif;?>
				</td>
			</tr>
