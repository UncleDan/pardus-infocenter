<?php
	...
	class SettingsMod
	{
		...
		const SCRIPT_VERSION = "2.0a1"; //please don't change that if you don't really need it
		...
		const PAGE_FAVICON = "http://www.pardus.at/favicon.ico"; // Upload a new favicon to the main directory and change this to "favicon.ico" to use a different one
		...
		const MAIN_PAGE_TITLE = "Main Page";  //Modify this so you can change the main page title
